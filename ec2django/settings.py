...
ASGI_APPLICATION = 'ec2django.routing.application'
...
STATIC_URL = '/static/'
# STATIC_ROOT = os.path.join(BASE_DIR, 'static') # добавил для отображения новой админки
